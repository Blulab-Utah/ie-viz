...
public class OwlToGraph_Labeled {
    ...
    public static void main(String[] args) throws Exception {
        ...
        OwlToGraph_Labeled main = new OwlToGraph_Labeled();
        main.createDBfromOnt(ontFile, graphFile);
    }

    private void createDBfromOnt(File ontFile, File graphFile) throws Exception {
...
//            }
    ...
    private void makeCopy(GraphDatabaseService graphDB) {
...
//            }
 //       }
    ...
    public enum NodeTypes implements Label{
        THING, INDIVIDUAL, COPY, ONTOLOGY, NOS,
