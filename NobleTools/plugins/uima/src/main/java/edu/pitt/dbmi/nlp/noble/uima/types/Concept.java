...
public class Concept extends Annotation {
  ...
  */  
  ...
  /** getter for modifiers - gets Set of mention modifiers
   * @generated
   * @return value of the feature 
   */
  public FSArray getModifiers() {
    if (Concept_Type.featOkTst && ((Concept_Type)jcasType).casFeat_modifiers == null)
      jcasType.jcas.throwFeatMissing("modifiers", "edu.pitt.dbmi.nlp.noble.uima.types.Concept");
    return (FSArray)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers)));}
    
  /** setter for modifiers - sets Set of mention modifiers 
   * @generated
   * @param v value to set into the feature 
   */
  public void setModifiers(FSArray v) {
    if (Concept_Type.featOkTst && ((Concept_Type)jcasType).casFeat_modifiers == null)
      jcasType.jcas.throwFeatMissing("modifiers", "edu.pitt.dbmi.nlp.noble.uima.types.Concept");
    jcasType.ll_cas.ll_setRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers, jcasType.ll_cas.ll_getFSRef(v));}    
    
  /** indexed getter for modifiers - gets an indexed value - Set of mention modifiers
   * @generated
   * @param i index in the array to get
   * @return value of the element at index i 
   */
  public Modifier getModifiers(int i) {
    if (Concept_Type.featOkTst && ((Concept_Type)jcasType).casFeat_modifiers == null)
      jcasType.jcas.throwFeatMissing("modifiers", "edu.pitt.dbmi.nlp.noble.uima.types.Concept");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers), i);
    return (Modifier)(jcasType.ll_cas.ll_getFSForRef(jcasType.ll_cas.ll_getRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers), i)));}

  /** indexed setter for modifiers - sets an indexed value - Set of mention modifiers
   * @generated
   * @param i index in the array to set
   * @param v value to set into the array 
   */
  public void setModifiers(int i, Modifier v) { 
    if (Concept_Type.featOkTst && ((Concept_Type)jcasType).casFeat_modifiers == null)
      jcasType.jcas.throwFeatMissing("modifiers", "edu.pitt.dbmi.nlp.noble.uima.types.Concept");
    jcasType.jcas.checkArrayBounds(jcasType.ll_cas.ll_getRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers), i);
    jcasType.ll_cas.ll_setRefArrayValue(jcasType.ll_cas.ll_getRefValue(addr, ((Concept_Type)jcasType).casFeatCode_modifiers), i, jcasType.ll_cas.ll_getFSRef(v));}
  }
