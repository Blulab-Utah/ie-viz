...
/* First created by JCasGen Wed Aug 17 16:48:14 EDT 2016 */
 ...
 * Updated by JCasGen Wed Aug 17 17:01:53 EDT 2016
 * @generated */
public class Concept_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public String getCui(int addr) {
      ...
      jcas.throwFeatMissing("cui", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public int getTuis(int addr) {
      ...
      jcas.throwFeatMissing("tuis", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public int getSynonyms(int addr) {
      ...
      jcas.throwFeatMissing("synonyms", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public String getCn(int addr) {
      ...
      jcas.throwFeatMissing("cn", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public String getPreferredTerm(int addr) {
      ...
      jcas.throwFeatMissing("preferredTerm", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public String getDefinition(int addr) {
      ...
      jcas.throwFeatMissing("definition", "edu.pitt.dbmi.nobletools.uima.types.Concept");
  ...
  public int getModifiers(int addr) {
      ...
      jcas.throwFeatMissing("modifiers", "edu.pitt.dbmi.nobletools.uima.types.Concept");
