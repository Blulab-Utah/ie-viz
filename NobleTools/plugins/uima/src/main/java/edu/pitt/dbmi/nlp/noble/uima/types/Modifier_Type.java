 ...
 * @generated */
public class Modifier_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.pitt.dbmi.nlp.noble.uima.types.Modifier");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "edu.pitt.dbmi.nlp.noble.uima.types.Modifier");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "edu.pitt.dbmi.nlp.noble.uima.types.Modifier");
